 ...
 *
 * syscall.h -- Defines the interface for and structures
 * relating to the syscall dispatch system.
 */
...
{ \
    int a; \
    asm volatile ("init $0x80" : "=a" (a) : "0" (num), "b" ((int) p1), "c" ((int) p2)); \
    return a; \
}
